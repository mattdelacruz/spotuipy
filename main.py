...
class Spotuify(App):
    ...
    def on_playback_monitor_playback_changed(
        self, message: PlaybackMonitor.PlaybackChanged
    ) -> None:
        self.query_one(CurrentTrack).on_playback_monitor_playback_changed(message)
        self.query_one(TrackProgress).on_playback_monitor_playback_changed(message)
        self.query_one(AlbumCover).on_playback_monitor_playback_changed(message)

    def on_playback_monitor_playback_stopped(
        self, message: PlaybackMonitor.PlaybackStopped
    ) -> None:
        self.query_one(CurrentTrack).on_playback_monitor_playback_stopped(message)
        self.query_one(TrackProgress).on_playback_monitor_playback_stopped(message)
        self.query_one(AlbumCover).on_playback_monitor_playback_stopped(message)

    def on_playback_monitor_track_ended(
        self, message: PlaybackMonitor.TrackEnded
    ) -> None:
