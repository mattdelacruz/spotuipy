...
class TrackProgress(Static):
    ...
    def make_progress(self) -> None:
        ...
        if track and track.get('item'):
            previous_progress_ms = self.progress_ms
            self.progress_ms = track['progress_ms']
            self.query_one("#track_progress", ProgressBar).advance(self.progress_ms - previous_progress_ms)
        ...
        # method to count the progress manually
        #
        #
...
class CurrentTrack(Static):
    ...
    def update_current_track(self) -> None:
        ...
        if track and track.get('item'):
            ...
            if self.query_one("#track-title", CurrentTrackLabel).label != track_name:
